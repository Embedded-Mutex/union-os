# union-os - A teaching operating system written in Rust

## Status

|   | Build & Test |
|---|:-----:|
|**all OS'**|[![Build & Test](https://dev.azure.com/RWTH-OS/union-os/_apis/build/status/RWTH-OS.union-os)](https://dev.azure.com/RWTH-OS/union-os/_build?definitionId=1)|
|**Linux only**|[![Build & Test](https://git.rwth-aachen.de/os/union-os/badges/master/pipeline.svg)](https://git.rwth-aachen.de/os/union-os/pipelines)|

## Introduction

<p align="center"><img src="/img/demo.gif?raw=true"/></p>

union-os is a Unix-like operating system based on a monolithic architecture for educational purposes.
...
union-os is derived from following tutorials and software distributions:
...
## Requirements to build union-os
union-os is tested under Linux, macOS, and Windows.
...
### Windows
To build union-os you have to install a linker, [make](http://gnuwin32.sourceforge.net/packages/make.htm) and a [git client](https://git-scm.com/downloads).
We tested the union-os with the linker from Visual Studio.
...
union-os is able to run within [ehyve](https://github.com/RWTH-OS/ehyve), which a specialized hypervisor for union-os.
...
```sh
$ # Get our source code.
$ git clone https://github.com/RWTH-OS/union-os.git
$ cd union-os
...
8. stage8 - Run Linux application as common process
   ...
   Start a simple Linux application (_HelloWorld_) on top of union-os. The application is a _position-independent executable_ (PIE) and use [musl-libc](http://www.musl-libc.org) as standard C library.
